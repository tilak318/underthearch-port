        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+918238169574" className="text-gray-400 hover:text-white transition-colors text-[17px]" target="_blank">+91 82381 69574</a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="text-gray-400 flex-shrink-0" size={18} />
                <a href="mailto:underthearch.in@gmail.com" className="text-gray-400 hover:text-white transition-colors text-[17px]" target="_blank">underthearch.in@gmail.com</a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Link to="/price-calculator" className="text-gray-400 hover:text-white transition-colors py-2">Price Calculator</Link>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">310, Silver Trade Center, opposite Uttran Power House Road, Uttran, Surat, Gujarat 395006</p>
                </div>
              </div>
